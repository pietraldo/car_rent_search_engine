...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("car_rent.Server.Model.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("car_rent.Server.Model.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("car_rent.Server.Model.Company", b =>
                {
            ...
            modelBuilder.Entity("car_rent.Server.Model.Offer", b =>
                {
            ...
            modelBuilder.Entity("car_rent.Server.Model.Rent", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("car_rent.Server.Model.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("car_rent.Server.Model.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("car_rent.Server.Model.Rent", b =>
                {
                    ...
                    b.HasOne("car_rent.Server.Model.Company", "Company")
                        .WithMany("Rents")
                        .HasForeignKey("Company_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("car_rent.Server.Model.Offer", "Offer")
                        .WithOne("Rent")
                        .HasForeignKey("car_rent.Server.Model.Rent", "Offer_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("car_rent.Server.Model.ApplicationUser", "User")
                        .WithMany("Rents")
